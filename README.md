...
- Automated feedback collection & processing  
- Focus on clean logic & usability  

📬 **Email Verification & Subscription System (PHP)**  
- Gmail SMTP + CRON jobs  
- File-based (no DB) implementation  
